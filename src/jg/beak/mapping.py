...
MAPPING = {
    ...
    re.compile(r"\bum[ěe]l[áa]\w*\s+inteligenc\w+", re.I): [AITag.chat],
    re.compile(r"\bartificial intelligence\b", re.I): [AITag.chat],
    re.compile(r"\bchat\s?gpt\b", re.I): [AITag.chat],
    re.compile(r"\bgemini\b", re.I): [AITag.chat],
    re.compile(r"\bclaude\b", re.I): [AITag.chat],
    re.compile(r"\bAI[-\s]?n[áa]stroj\w+", re.I): [AITag.chat],
    re.compile(r"\bAI tools?\b", re.I): [AITag.chat],
    re.compile(
        r"\bAI[-\s](first|native|driven|powered|assisted|ready)\b", re.I
    ): [AITag.chat],
    re.compile(r"\bclaude code\b", re.I): [AITag.chat, AITag.agents],
    ...
    re.compile(r"\bjetbrains ai\b", re.I): [AITag.chat, AITag.agents],
    re.compile(r"\b(ai\s+)?coding agent\w*\b", re.I): [AITag.chat, AITag.agents],
    ...
    re.compile(r"\bpracovat agentn\w+", re.I): [AITag.chat, AITag.agents],
    re.compile(r"\bLLMs?\b"): [AITag.chat, AITag.build],
    re.compile(r"\blarge language model\w*", re.I): [AITag.chat, AITag.build],
    ...
    re.compile(r"\bprompt engineer\w*", re.I): [AITag.chat, AITag.build],
    re.compile(r"\b(langchain|llama[-\s]?index|semantic kernel)\b", re.I): [
        AITag.chat,
        AITag.build,
    ],
    re.compile(r"\bvector\s?(database|db)\b", re.I): [AITag.chat, AITag.build],
    ...
    re.compile(r"\bmachine learning\b", re.I): [AITag.chat, AITag.build],
    re.compile(r"\bstrojov\w+\s+u[čc]en\w+", re.I): [AITag.chat, AITag.build],
    re.compile(r"\bML\b"): [AITag.chat, AITag.build],
    re.compile(r"\bdeep learning\b", re.I): [AITag.chat, AITag.build],
    re.compile(r"\bhlubok\w+\s+u[čc]en\w+", re.I): [AITag.chat, AITag.build],
    re.compile(r"\bneural net\w*", re.I): [AITag.chat, AITag.build],
